                      ...
                      fluidRow(
                               column(width=8,
                                   ...
                                   p("This dashboard is intended to: (1) provide an overview and inspiration of interesting trends in and links between wildfire data and climate data;
                                     (2) offer easy-to-modify visualizations to uncover more of the goals in item (1)! The data span from 2001 through 2015 and include common wildfire, climate, and air quality data for California only.",
